...
- [Skills + CLI](https://docs.firecrawl.dev/sdks/cli)
- [Build with AI](https://docs.firecrawl.dev/ai-onboarding)
...
- [Debug with Ask](https://docs.firecrawl.dev/features/ask)
...
- [Video extraction](https://docs.firecrawl.dev/features/scrape#video-extraction)
- [Question format](https://docs.firecrawl.dev/features/scrape#question-format)
- [Highlights format](https://docs.firecrawl.dev/features/scrape#highlights-format)
